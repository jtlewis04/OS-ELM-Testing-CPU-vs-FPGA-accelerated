...
################################################################
# This is a generated script based on design: os_elm_block
#
...
# source os_elm_block_script.tcl
...
xilinx.com:hls:os_elm_core:1.0\
...
\
    ...
    CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {249.999954} \
...
\
  ...
  # Create instance: os_elm_core_0, and set properties
  set os_elm_core_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:os_elm_core:1.0 os_elm_core_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins os_elm_core_0/in_stream]
  ...
  connect_bd_intf_net -intf_net os_elm_core_0_out_stream [get_bd_intf_pins os_elm_core_0/out_stream] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins os_elm_core_0/ap_rst_n] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins os_elm_core_0/ap_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
